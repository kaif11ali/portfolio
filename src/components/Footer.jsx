        ...
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#services" className="text-gray-300 hover:text-[#F2A93B] transition-colors">
                  Services
                </a>
              </li>
              <li>
                <a href="#projects" className="text-gray-300 hover:text-[#F2A93B] transition-colors">
                  Projects
                </a>
              </li>
              <li>
                <a href="#contact" className="text-gray-300 hover:text-[#F2A93B] transition-colors">
                  Contact
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              >
                <svg className="w-5 h-5 text-[#1A3C34]" fill="currentColor" viewBox="0 0 24 24">
