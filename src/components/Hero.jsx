...
const Hero = () => {
  return (
    <section id="home" className="bg-[#F7F5EE] py-20 px-8">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        
        {/* Left Column - Text Content */}
        <div className="space-y-6">
          <div>
            <h2 className="text-[#1A3C34] text-xl md:text-2xl mb-2" style={{ fontFamily: 'Caveat, cursive' }}>
              Hy! I Am
            </h2>
            <h1 className="text-[#F2A93B] text-5xl md:text-7xl font-bold mb-4" style={{ fontFamily: 'Caveat, cursive' }}>
              KF.
            </h1>
          ...
          <div className="flex items-center space-x-8">
            <div>
              <div className="text-4xl font-bold text-[#F2A93B]">1+</div>
              <div className="text-[#43645C] text-sm">Years Experience</div>
            </div>
            <div>
              <div className="text-4xl font-bold text-[#F2A93B]">85+</div>
              <div className="text-[#43645C] text-sm">Projects Completed</div>
            </div>
          </div>

          {/* Social Icons */}
          <div className="flex space-x-4 pt-4">
            <a href="https://github.com/kaif11ali" target="_blank" rel="noopener noreferrer" 
               className="w-12 h-12 bg-white rounded-full flex items-center justify-center hover:bg-[#F2A93B] transition-colors shadow-md"
               aria-label="Visit Kaif Ali's GitHub Profile">
              <svg className="w-6 h-6 text-[#1A3C34]" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <a href="https://www.linkedin.com/in/kaifali/" target="_blank" rel="noopener noreferrer"
               className="w-12 h-12 bg-white rounded-full flex items-center justify-center hover:bg-[#F2A93B] transition-colors shadow-md"
               aria-label="Connect with Kaif Ali on LinkedIn">
              <svg className="w-6 h-6 text-[#1A3C34]" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
              </svg>
            </a>
            <a href="https://wa.me/7779018599" target="_blank" rel="noopener noreferrer"
               className="w-12 h-12 bg-white rounded-full flex items-center justify-center hover:bg-[#F2A93B] transition-colors shadow-md"
               aria-label="Contact Kaif Ali on WhatsApp">
              <svg className="w-6 h-6 text-[#1A3C34]" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
